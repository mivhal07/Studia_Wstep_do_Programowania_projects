...
public class tenth10 {
    ...
    public static void main(String[] args) {
        ...
        rokIopady(podsuma, deszcz, suma);//tutaj
        ...
        srednieMiesieczne(podsuma, deszcz);//i tutaj
    }

    public static void srednieMiesieczne(double podsuma, double[][] deszcz) {

        for (int m = 0; m < miesiące; m++) {
    ...
    public static void rokIopady(double podsuma, double[][] deszcz, double suma) {
